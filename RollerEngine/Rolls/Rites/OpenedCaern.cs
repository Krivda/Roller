...
namespace RollerEngine.Rolls.Rites
{
    public class OpenedCaern : RiteRoll
    {
         ...
         */
        public OpenedCaern(IRollLogger log, IRoller roller) :
    ...
    {
        public Binding(IRollLogger log, IRoller roller) :
    ...
    {
        public SpiritAwakening(IRollLogger log, IRoller roller) :
    ...
    {
        public Summoning(IRollLogger log, IRoller roller) :
    ...
    {
        public CrashSpace(IRollLogger log, IRoller roller) :
    ...
    {
        public Knowing(IRollLogger log, IRoller roller) :
