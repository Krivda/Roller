...
namespace UnitTests
{
    ...
    class AnsestorsTest
    {
        ...
        public void AnscestorsTest()
        {
            ...
            Assert.AreEqual(-1, user.AncestorsUsesLeft, "botch should have spoiled further attempts");

            user.AncestorsUsesLeft = 50;
            user.HasAncestorVeneration = true;
            //test veneration fixes 
            var roller2 = new MockFixedRoller(new List<int>(){-1, 1});
            ...
            Assert.AreEqual(49, user.AncestorsUsesLeft, "botch should have 49 further attempts");

            var roller3 = new MockFixedRoller(new List<int>() { -1, 0 });
            ...
            Assert.AreEqual(48, user.AncestorsUsesLeft, "botch should have 48 further attempts");
        }
    }
}