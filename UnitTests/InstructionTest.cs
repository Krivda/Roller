...
using RollerEngine.Rolls.Skills;
    ...
    class InstructionTest
    {
        ...
        public void TestInstructionTeach()
        {
            ...
            string xpPoolOccult = Build.DynamicTraits.GetKey(Build.DynamicTraits.ExpirienceToLearn, Build.Abilities.Occult);
            string xpConsumedOcuult = Build.DynamicTraits.GetKey(Build.DynamicTraits.ExpirienceLearned, Build.Abilities.Occult);
            ...
            Assert.AreEqual(1, student.Traits[xpConsumedOcuult], "Student should have 1 XP learned towards a point in Occult.");
            ...
            Assert.AreEqual(2, student.Traits[xpConsumedOcuult], "Student should have 2 XP learned towards a point in Occult.");
            ...
            Assert.AreEqual(0, student.Traits[xpPoolOccult], "Student should have 0 more XP on  to spend on Occult");
            Assert.AreEqual(0, student.Traits[xpConsumedOcuult], "Student should have 0 XP learned towards a point in Occult.");
            ...
            Assert.AreEqual(5, student.Traits[xpConsumedOcuult], "Student should have 5 XP learned towards a point in Occult.");
